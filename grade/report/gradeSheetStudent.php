...
$studentList = $staff->getAllStudentByCourse($crsID, $period);
//print_r($studentList);
...
foreach ($studentList as $student) {	
	$studInfo=$staff->getStudentStanding($student['studLevelID'], $period);
	$grades = $staff->getAllGradesOfStudent($student['studLevelID'], $period);
	if($grades == 0 || count($grades) == 0) continue;
