                              ...
                              <tbody>
                                ...
                                <?php foreach ($subjectList as $subject): 
                                      ...
                                      if(count($approvalStatus)!=1){
                                          ...
                                          if($approvalStatus['appDean'] === '1'){
                                            $status = "<td class='text-success'>Approved</td>";
                                            
                                          }else if($approvalStatus['appHead']=== '1' && $approvalStatus['appDean'] === '0'){
                                            $status = "<td class='text-warning'>Pending</td>";
                                            $action="<td style='text-align: center'><input type='checkbox' /></td>";         
                                          }else{
                                            $status = "<td class='text-danger'>Not yet approved by the Department Head</td>";
                                            $showSubjectLink = false;  
                                          }
   ...
   <script>
        $(document).ready(function(){  
            ...
            $(document).on("click", "#btn-headApproval", function(){
              ...
              $.post("../Model/Service.php",
                      {season: season, term:term, objJSON, objJSON, action: "deanApproval"},
                      function(data){
                        alert(data);
                        $("#refresh").click();
                      }
